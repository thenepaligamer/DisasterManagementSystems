...
const useDistrictComponent = (
    props = { province: null, district: null, local: null }
) => {
    ...
    function changeDistrict() {
        ...
        const district = Object.getOwnPropertyDescriptor(
            districtUtil,
            selectedProvince
        );
        ...
        const local = Object.getOwnPropertyDescriptor(
            localBodies,
            selectedDistrict
        ...
        <>
            <div className="flex ">
                ...
                <select
                    ...
                    defaultValue={props.province || "default"}
                    value={props.province}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                >
                    <option value={props.province || "default"}>
                        Choose a Province
                    </option>
            ...
            <div className="flex ">
                ...
                <select
                    ...
                    onChange={changeDistrict}
                    name="district"
                    defaultValue={props.district || "default"}
                    ref={districtSelected}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                >
                    <option value={props.district || "default"}>
                        Choose a District
                    </option>
                    {provinceAvailable &&
                        provinceAvailable.map((district) => (
            ...
            <div className="flex ">
                ...
                <select
                    ...
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                >
                    <option value={props.local || "default"}>
                        Choose a LocalBody
                    </option>
                    {localBodyAvailable &&
                        localBodyAvailable.map((localBody) => (
                            <option value={localBody} key={localBody}>
                                {localBody}
                            </option>
                        ))}
                </select>
